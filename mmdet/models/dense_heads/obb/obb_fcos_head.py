...
class OBBFCOSHead(OBBAnchorFreeHead):
    ...
    def __init__(self,
        ...
        #mc dropout
        self.use_MCdropout = use_MCdropout
    ...
    def _init_layers(self):
        ...
        if self.use_MCdropout:
            self._init_cls_convs_withMCdropout()
            self._init_reg_convs_withMCdropout()
        else:
    ...
    def _init_cls_convs_withMCdropout(self):
        ...
        for i in range(self.stacked_convs):
            ...
            self.cls_convs.append(
                ConvModule(
                    ...
                    bias=self.conv_bias))
            #insert dropout layer after the first conv
            if i==0:
                self.cls_convs.append(nn.Dropout(self.dropout_rate))
        print(self.cls_convs)

    def _init_reg_convs_withMCdropout(self):
        ...
        for i in range(self.stacked_convs):
            ...
            self.reg_convs.append(
                ConvModule(
                    ...
                    bias=self.conv_bias))
            if i==0:
                self.reg_convs.append(nn.Dropout(self.dropout_rate))
